...
This script truncates all documents above a given length and right pads documents below that length. 
...
> 2. Documents below length `xxx` were right padded with zeros.
>
